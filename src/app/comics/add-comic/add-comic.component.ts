...
export class AddComicComponent {
  ...
  updateDesc(){
    this.short = this.title + " #" + this.issue + " (" + this.year + ") " + " is an Amazing " + this.type + " comic by " + this.publisher + " Comics.  Written by " + this.writer + " & Art by " + this.artist + "... with an appearance of " + this.characters + ".";
    this.description = this.title + " (" + this.year + ") " + " is an Amazing " + this.type + " by " + this.publisher + ".  Written by " + this.writer + " & Art by " + this.artist + "... with an appearance of " + this.characters + ".  Excellent Condition (" + this.grade + " out of 10) for it's age (" + this.year + ").  Bagged & Boarded.";
  };
